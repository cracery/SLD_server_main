...
def preproc_img(img: np.ndarray) -> np.ndarray:
    """
...
def format_emo_vec(emotions:Dict[str, float]) -> np.ndarray:
    """
...
def format_result(level: str, probabilities: Dict[str, float], threshold: float = 0.5) -> Dict[str, Any]:
    """
